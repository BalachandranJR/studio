...
import { PlaneTakeoff, MailCheck } from "lucide-react";
  ...
  return (
    <main className="container mx-auto px-4 py-8 md:py-12">
      ...
      <div className="max-w-4xl mx-auto">
        {!itinerary && !isLoading && !isSubmitted && (
          <Card>
            <CardHeader>
        ...
        {isSubmitted && !isLoading && (
          <Card className="text-center p-8">
            ...
            <CardTitle className="font-headline text-2xl mt-4">Request Received!</CardTitle>
            <CardDescription className="mt-2">
              Your itinerary is being generated by our AI assistant. In a real application, this would be delivered to you shortly (e.g., via email).
            </CardDescription>
            <div className="mt-6">
                <button
                  onClick={resetForm}
